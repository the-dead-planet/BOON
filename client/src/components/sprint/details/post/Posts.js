...
const PostsImpl = ({ user, _id, posts, comments, likes, authors, push }) => {
    return <PostsList user={user} posts={posts} comments={comments} likes={likes} authors={authors} push={push} />;
};
